...
function App() {
  ...
  const advancedSentimentAnalysis = (text) => {
    ...
    const emotionKeywords = {
      joy: ['happy', 'joy', 'excited', 'amazing', 'wonderful', 'fantastic', 'great', 'awesome', 'love', 'perfect', 'brilliant', 'excellent'],
      anger: ['angry', 'mad', 'furious', 'hate', 'terrible', 'awful', 'worst', 'disgusting', 'annoying', 'frustrated'],
      sadness: ['sad', 'depressed', 'disappointed', 'heartbroken', 'crying', 'upset', 'miserable', 'lonely'],
      fear: ['scared', 'afraid', 'worried', 'anxious', 'nervous', 'terrified', 'panic', 'frightened'],
      surprise: ['wow', 'amazing', 'incredible', 'unbelievable', 'shocking', 'surprised', 'unexpected']
    }
  ...
  const getOverallStats = () => {
    ...
    const totalEmotions = posts.reduce((acc, post) => {
      if (post.emotions) {
        Object.entries(post.emotions).forEach(([emotion, value]) => {
    ...
    return {
      ...
      commentPositivityRate: commentStats.totalCommentsSentiment > 0 
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Analyze the sentiment of your Instagram posts and understand how your audience responds to your content.
          </p>
        </div>
            ...
            <div className="text-center">
              <div className="mb-6">
                ...
                <p className="text-gray-600">
                  Login with Facebook to analyze your Instagram business account posts
                </p>
              </div>
          ...
          <div>
            ...
            <div className="flex justify-between items-center mb-8">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Select an Instagram account to get started</p>
                </div>
              </div>
              <button
                onClick={logout}
            ...
            {stats && (
              <div className="bg-white rounded-lg shadow-lg p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-6">📈 Overall Sentiment Analysis</h3>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  <div className="text-center p-4 bg-purple-50 rounded-lg">
                    <div className="text-2xl font-bold text-purple-600">{stats.avgLikes}</div>
                  ...
                  <div className="text-center p-4 bg-pink-50 rounded-lg">
                    <div className="text-2xl font-bold text-pink-600">{stats.engagementRate}</div>
                    <div className="text-sm text-gray-600">Engagement Rate</div>
                  </div>
                  <div className="text-center p-4 bg-yellow-50 rounded-lg">
                    <div className="text-2xl font-bold text-yellow-600">{((stats.positive / stats.totalPosts) * 100).toFixed(1)}%</div>
                ...
                {stats.postsWithCommentAnalysis > 0 && (
                  <div className="mb-6">
                    <h4 className="text-lg font-semibold text-gray-900 mb-4">💬 Comment Sentiment Overview</h4>
        ...
        <div className="mt-12 text-center text-gray-500 text-sm">
          ...
          <p className="mt-2">Instagram Sentiment Analysis - Powered by AI</p>
        </div>
      </div>
    </div>
  )
