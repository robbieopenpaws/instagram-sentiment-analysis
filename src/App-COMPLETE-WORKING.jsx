...
function App() {
  const [user, setUser] = useState({ id: 'demo', accessToken: 'demo' }); // Start logged in for demo
        ...
        {!user ? (
          <div className="login-section">
            <div className="login-card">
              ...
              <button 
                onClick={() => setUser({ id: 'demo', accessToken: 'demo' })}
          ...
          <div className="dashboard">
            ...
            <div className="section">
              ...
              <div className="controls">
                <button 
                  onClick={loadInstagramPost}
                  disabled={loading}
                  className="load-btn"
                >
                  {loading ? 'Loading...' : 'Load Instagram Post'}
                </button>
              </div>
